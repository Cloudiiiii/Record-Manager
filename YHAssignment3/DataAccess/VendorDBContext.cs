...
namespace YHAssignment3.DataAccess
{
    public class VendorDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Vendor>().Navigation(i => i.Invoices).AutoInclude();
            modelBuilder.Entity<PaymentTerms>().Navigation(i => i.Invoices).AutoInclude();
            modelBuilder.Entity<Invoice>().Navigation(i => i.InvoiceLineItems).AutoInclude();
